...
//    [FindUtils runInMainQueue:^{
//        [[NSNotificationCenter defaultCenter] postNotificationName:NOTIFICATION_WEBVIEW_LOAD_FINISH object:self userInfo:nil];
//    }];
...
- (void)webView:(UIWebView *)webView didFailLoadWithError:(NSError *)error {
    if (webView != _webView) { return; }
//    [InterfaceHUD showErrorHUDWithString:@"加载失败，请稍候重试"];
    _numRequestsLoading--;
...
{
    if (!self.loadFinish) {
//        [InterfaceHUD showHUDWithStatus:@"加载中请稍候..."];
    }
}
