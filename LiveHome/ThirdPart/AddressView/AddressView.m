...
- (instancetype)initWithFrame:(CGRect)frame{
    ...
    if (self) {
        ...
        UIView *tapView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, SCREEN_WIDTH, SCREEN_HEIGHT -350 *IPHONE6_SIZE)];
...
//        NSLog(@"%@",arr);
        ...
        self.myView = [[UIView alloc] initWithFrame:CGRectMake(0, SCREEN_HEIGHT, SCREEN_WIDTH, 350 *IPHONE6_SIZE)];
...
- (AddressTableView *)tableView2{
    ...
    if (!_tableView2) {
        ...
        _tableView2.block = ^(NSInteger row){
            ...
            arr = [citiesVO.areas mutableCopy];
            [arr insertObject:@"全部" atIndex:0];
            
            weakSelf.datasArr2 = arr;
...
//            weakSelf.block([NSString stringWithFormat:@"%@ %@ %@",weakSelf.stateLabel.text,weakSelf.cityLabel.text,weakSelf.datasArr2[row]]);
            weakSelf.block(
                           [NSString stringWithFormat:@"%@",weakSelf.stateLabel.text],
                            [NSString stringWithFormat:@"%@",weakSelf.cityLabel.text],
                             [NSString stringWithFormat:@"%@",weakSelf.datasArr2[row]]
                              );
...
- (void)tapClick{
    ...
    [UIView animateWithDuration:0.3f animations:^{
        ...
        self.myView.frame = CGRectMake(0, SCREEN_HEIGHT, SCREEN_WIDTH, 350 *IPHONE6_SIZE);
...
- (void)showView:(UIView *)supView{
    ...
    [UIView animateWithDuration:0.3f animations:^{
        ...
        self.myView.frame = CGRectMake(0, SCREEN_HEIGHT -350 *IPHONE6_SIZE, SCREEN_WIDTH, 350 *IPHONE6_SIZE);
